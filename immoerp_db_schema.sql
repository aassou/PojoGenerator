...
CREATE TABLE `table_property` (
  ...
  `official_size` decimal(10,2) DEFAULT NULL,
  `secondary_size` decimal(10,2) DEFAULT NULL,
...
CREATE TABLE `table_apartment` (
  ...
  `official_advance_amount` decimal(10,2) DEFAULT NULL,
  `created` datetime DEFAULT NULL,
  `created_by` varchar(50) DEFAULT NULL,
  `updated` datetime DEFAULT NULL,
  `updated_by` varchar(50) DEFAULT NULL,
...
CREATE TABLE `table_customer_contract` (
  ...
  `month_periods` int DEFAULT NULL,
  `financial_commitment` decimal(12,2) DEFAULT NULL,
  `change_request` text,
  ...
  `arabic_company_name` int DEFAULT NULL,
...
CREATE TABLE `table_project` (
  ...
  `arabic_address` varchar(255) DEFAULT NULL,
  `project_sorting` float DEFAULT NULL,
  `land_title` varchar(255) DEFAULT NULL,
  ...
  `stairwell` decimal(9,2) DEFAULT NULL,
  ...
  `architect_name` text,
  `reinforced_concrete_architect_name` text DEFAULT NULL,
  `status` int DEFAULT NULL,
